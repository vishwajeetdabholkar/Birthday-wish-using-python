...
class color:
   ...
   UNDERLINE = '\033[4m'
   END = '\033[0m'
name = "Vishu" #input("What is your name? ")
...
try:
	...
	sys.stdout.write(color.BLUE+'Ha')
	winsound.Beep(264, 250)
	time.sleep(500/2000.0)
	sys.stdout.write('ppy ')
	winsound.Beep(264, 250)
	...
	print(color.PURPLE+name+color.END)
	time.sleep(250/2000.0)
	winsound.Beep(297, 1000)
	...
	time.sleep(500/2000.0)
	sys.stdout.write(color.GREEN+'Ha')
